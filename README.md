...
Input a writing task and a student response. KP Writing Lab turns them into a structured report with marked errors, explanations, model rewrite, scoring, and archive-ready metadata.
